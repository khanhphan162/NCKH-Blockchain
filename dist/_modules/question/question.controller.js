...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: create_question_dto_1.CreateQuestionDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', required: true, description: 'Question ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', required: true, description: 'Question ID to update' }),
