...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "enrollment-uuid", description: "Enrollment ID" }),
    __metadata("design:type", String)
], EnrollmentResponseDto.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "user-uuid", description: "User ID who enrolled" }),
    __metadata("design:type", String)
], EnrollmentResponseDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "course-uuid", description: "Course ID" }),
    __metadata("design:type", String)
], EnrollmentResponseDto.prototype, "courseId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "2024-03-01T12:00:00Z", description: "Enrollment created date" }),
