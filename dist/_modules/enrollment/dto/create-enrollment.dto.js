...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "user-uuid", description: "User ID who enrolls in the course" }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateEnrollmentDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "course-uuid", description: "Course ID to enroll in" }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
