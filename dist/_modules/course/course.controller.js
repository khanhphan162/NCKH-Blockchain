...
const jwt_auth_guard_1 = require("../../_modules/guard/jwt-auth.guard");
const role_guard_1 = require("../../_modules/guard/role.guard");
...
let CourseController = class CourseController {
    ...
    async create(createCourseDto, user) {
        if (!user || !user.userId) {
            throw new common_1.UnauthorizedException("User ID is missing in token");
        }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new course (Only for INSTRUCTORS)' }),
